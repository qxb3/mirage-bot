...
module.exports = {
    ...
    callback: async () => {
        const embed = new MessageEmbed()
            ...
            .addFields([
                { name: '❯ Note', value: 'I am gonna discontinue this project for secret reasons, Anyway while im gone the bot are still gonna be up and running and if you want you to help with the bot can go ahead and help me, The source code are gonna be below so you can go ahead and contribute\nGithub: https://github.com/qxb3/mirage-bot' },
